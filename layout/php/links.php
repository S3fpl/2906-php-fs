<?php
$oldLinks = [
    ['url' => '/layout/start/simple_greeting.php', 'text' => 'Simple Greeting'],
    ['url' => '/layout/start/age_message.php', 'text' => 'Age Message'],
    ['url' => '/layout/start/sum_of_two_numbers.php', 'text' => 'Sum of Two Numbers'],
    ['url' => '/layout/start/multiplication_table.php', 'text' => 'Multiplication Table'],
    ['url' => '/layout/start/full_name.php', 'text' => 'Full Name'],
    ['url' => '/layout/start/person_introduction.php', 'text' => 'Person Introduction'],
    ['url' => '/layout/start/simple_discount.php', 'text' => 'Simple Discount'],
    ['url' => '/layout/start/rectangle_area.php', 'text' => 'Rectangle Area'],
    ['url' => '/layout/start/simple_calculator.php', 'text' => 'Simple Calculator'],
    ['url' => '/layout/start/temperature_converter.php', 'text' => 'Temperature Converter'],
    ['url' => '/layout/start/circle_area.php', 'text' => 'Circle Area'],
    ['url' => '/layout/start/discount_price.php', 'text' => 'Discount Price'],
    ['url' => '/layout/start/concat_strings.php', 'text' => 'Concat Strings'],
    ['url' => '/layout/start/exchange_rate.php', 'text' => 'Exchange Rate'],
    ['url' => '/layout/start/add_prefix_to_name.php', 'text' => 'Add Prefix to Name'],
    ['url' => '/layout/start/string_length.php', 'text' => 'Length of a String'],
    ['url' => '/layout/start/personalized_welcome.php', 'text' => 'Personalized Welcome'],
    ['url' => '/layout/start/power_of_number.php', 'text' => 'Power of Number'],
];
